let num1Display = document.querySelector('#num1Display');
const operationDisplay = document.querySelector('#operationDisplay');
const num2Display = document.querySelector('#num2Display');

const numLvl2Score = document.querySelector('#numLvl2Score');
...
recognition.onresult = (event) => {
  ...
  if(operation === " + "){
    ...
    if(parseInt(number) === answer){
      ...
      score += 1;
      equationsTTS.text = "Correct! You're doing great!";
    }
  ...
  console.log(answer);
    if(parseInt(number) === answer){
      document.body.style.backgroundColor = "green";
      score += 1;
      equationsTTS.text = 'Correct! Keep it up!';
    }
    else{
      document.body.style.backgroundColor = "red";
      equationsTTS.text = `Incorrect, the right answer is ${answer}. Try again`;
  ...
  numLvl2Score.textContent = `Score: ${score}`;
